...
def _create_data(idx, input_paths):
  ...
  print('fffffffffffffffffffffffffffffffffffffff' + tfrecord_dir)
...
if __name__ == "__main__":
  ...
  flags.DEFINE_string("input_glob", "./data/*.txt",
                      help="Input file glob.")
  flags.DEFINE_string("sp_path", "./spiece/spiece.model", help="Path to the sentence piece model.")
  flags.DEFINE_string("save_dir", "./proc_data",
