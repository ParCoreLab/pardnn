...
class Graph{
  ...
  void calc_nodes_tmp_top_levels(const unordered_map<string, bool>&, unordered_map<string, int>&, vector<string>&, unordered_map<string, int>, bool);
  string calc_nodes_tmp_bottom_levels(const unordered_map<string, bool>&, unordered_map<string, int>&, vector<string>&, unordered_map<string, int>);
  string calc_nodes_tmp_weighted_level(const unordered_map<string, bool>&, unordered_map<string, int>&, vector<string>&, vector<string>&,
  unordered_map<string, int>&, unordered_map<string, int>&);
  void obtain_linear_clusters();
  void obtain_mapped_clusters();
  void obtain_clusters_comms(unordered_map<LinearCluster*, unordered_map <LinearCluster*, int>>&, unordered_map<LinearCluster*, int>&,  unordered_map<LinearCluster *, int> &, vector<LinearCluster>&, bool);
  void long_term_comms(map<int, long long int> &);
  void obtain_clusters_spans(unordered_map<LinearCluster*, pair<int, int>>&, vector<LinearCluster>&);
  void merge_clusters(LinearCluster* , LinearCluster*, bool, int *, int *, unordered_map<LinearCluster*, unordered_map <LinearCluster*, int>>&, unordered_map<LinearCluster*, int>&,  unordered_map<LinearCluster*, int>&);
  LinearCluster* max_communicating(LinearCluster* , unordered_map<LinearCluster*, unordered_map <LinearCluster*, int>>&);
  ...
  int max_communicating_primary(LinearCluster* , unordered_map<LinearCluster*, unordered_map <LinearCluster*, int>>&);
  void collocate();
